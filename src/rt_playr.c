...
weaponinfo DOGSCRATCH = {
	128, 5,
	0,	 0,
	4,	 {{done, 2, 8}, {at_pulltrigger, 2, 9}, {done, 2, 10}, {reset, 2, 11}}};

weaponinfo DOGLICK = {
	128, 5, 0, 0, 4, {{done, 2, 4}, {done, 2, 5}, {done, 2, 6}, {reset, 2, 7}}};
...
weaponinfo WEAPONS[MAXWEAPONS] =
	...
	{{100,
	  ...
	  0x2000l,
	  3,
	  {{at_pulltrigger, 4, 1}, {done, 4, 2}, {reset, 4, 0}}}, // single pistol
	 {100,
	  -1,
	  10,
	  0x2000l,
...

{
	...
	{
		// LT added: if autoAimMissileWeps is true (as well as autoAim), then
		// missile weapons will be aimed similarly to bullet weapons
