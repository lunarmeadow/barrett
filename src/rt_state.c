...
statetype s_lowgrddie1rev = {false, SPR_LOWGRD_DIE1, 8, T_Collide,
							 0,		&s_lowgrdstand};
statetype s_lowgrddie2rev = {false, SPR_LOWGRD_DIE2, 8, T_Collide,
							 0,		&s_lowgrddie1rev};
statetype s_lowgrddie3rev = {false, SPR_LOWGRD_DIE3, 8, T_Collide,
							 0,		&s_lowgrddie2rev};
statetype s_lowgrddie4rev = {false, SPR_LOWGRD_DIE4, 8, T_Collide,
							 0,		&s_lowgrddie3rev};
statetype s_lowgrddeadrev = {false, SPR_LOWGRD_DEAD, 0, T_Collide,
							 0,		&s_lowgrddie4rev};

statetype s_lowgrdcrushed2 = {false, SPR_LOWGRD_DIE3, 2, NULL,
							  0,	 &s_lowgrddead};
...
statetype s_highgrddie1rev = {false, SPR_HIGHGRD_DIE1, 8, T_Collide,
							  0,	 &s_highgrdstand};
statetype s_highgrddie2rev = {false, SPR_HIGHGRD_DIE2, 8, T_Collide,
							  0,	 &s_highgrddie1rev};
statetype s_highgrddie3rev = {false, SPR_HIGHGRD_DIE3, 8, T_Collide,
							  0,	 &s_highgrddie2rev};
statetype s_highgrddie4rev = {false, SPR_HIGHGRD_DIE4, 8, T_Collide,
							  0,	 &s_highgrddie3rev};
statetype s_highgrddie5rev = {false, SPR_HIGHGRD_DIE5, 0, T_Collide,
							  0,	 &s_highgrddie4rev};
...
statetype s_strikedie1rev = {false, SPR_STRIKE_DIE1, 7, T_Collide,
							 0,		&s_strikestand};
statetype s_strikedie2rev = {false, SPR_STRIKE_DIE2, 7, T_Collide,
							 0,		&s_strikedie1rev};
statetype s_strikedie3rev = {false, SPR_STRIKE_DIE3, 7, T_Collide,
							 0,		&s_strikedie2rev};
statetype s_strikedie4rev = {false, SPR_STRIKE_DIE4, 7, T_Collide,
							 0,		&s_strikedie3rev};

statetype s_strikecrushed2 = {false, SPR_STRIKE_DIE3, 2, NULL,
							  0,	 &s_strikedead};
...
statetype s_blitzdead2 = {false, SPR_BLITZ_DEAD2, 0, T_Collide,
						  0,	 &s_blitzdead2};
statetype s_blitzdead = {false, SPR_BLITZ_DEAD1, 0, T_Collide,
						 0,		&s_blitzdead2};
...
statetype s_blitzdie1rev = {false, SPR_BLITZ_DIE1, 7, T_Collide,
							0,	   &s_blitzstand};
statetype s_blitzdie2rev = {false, SPR_BLITZ_DIE2, 7, T_Collide,
							0,	   &s_blitzdie1rev};
statetype s_blitzdie3rev = {false, SPR_BLITZ_DIE3, 7, T_Collide,
							0,	   &s_blitzdie2rev};
statetype s_blitzdie4rev = {false, SPR_BLITZ_DIE4, 7, T_Collide,
							0,	   &s_blitzdie3rev};
...
statetype s_blitzplead10 = {false, SPR_BLITZ_PLEAD10, 6, NULL,
							0,	   &s_blitzplead11};
statetype s_blitzplead9 = {false, SPR_BLITZ_PLEAD9, 6, NULL,
						   0,	  &s_blitzplead10};
...
statetype s_enforcerdie1rev = {false, SPR_ENFORCER_DIE1, 7, T_Collide,
							   0,	  &s_enforcerstand};
statetype s_enforcerdie2rev = {false, SPR_ENFORCER_DIE2, 7, T_Collide,
							   0,	  &s_enforcerdie1rev};
statetype s_enforcerdie3rev = {false, SPR_ENFORCER_DIE3, 7, T_Collide,
							   0,	  &s_enforcerdie2rev};
statetype s_enforcerdie4rev = {false, SPR_ENFORCER_DIE4, 7, T_Collide,
							   0,	  &s_enforcerdie3rev};
...
statetype s_robogrdstand = {16, SPR_ROBOGRD_S11, 0, T_Stand,
							0,	&s_robogrdstand};
...
statetype s_grexplosion9 = {false, SPR_GROUNDEXPL9, 2, NULL,
							0,	   &s_grexplosion10};
statetype s_grexplosion8 = {false, SPR_GROUNDEXPL8, 2, NULL,
							0,	   &s_grexplosion9};
statetype s_grexplosion7 = {false, SPR_GROUNDEXPL7, 2, NULL,
							0,	   &s_grexplosion8};
statetype s_grexplosion6 = {false, SPR_GROUNDEXPL6, 2, NULL,
							0,	   &s_grexplosion7};
statetype s_grexplosion5 = {false, SPR_GROUNDEXPL5, 2, NULL,
							0,	   &s_grexplosion6};
statetype s_grexplosion4 = {false, SPR_GROUNDEXPL4, 2, NULL,
							0,	   &s_grexplosion5};
statetype s_grexplosion3 = {false, SPR_GROUNDEXPL3, 2, T_Explosion,
							0,	   &s_grexplosion4};
statetype s_grexplosion2 = {false, SPR_GROUNDEXPL2, 2, NULL,
							0,	   &s_grexplosion3};
statetype s_grexplosion1 = {false, SPR_GROUNDEXPL1, 2, NULL,
							0,	   &s_grexplosion2};
...
statetype s_firejetup8 = {false,  FIREJETUP8, 3,
						  T_Path, SF_CRUSH,	  &s_firejetup9};
statetype s_firejetup7 = {false,  FIREJETUP7, 3,
						  T_Path, SF_CRUSH,	  &s_firejetup8};
statetype s_firejetup6 = {false,  FIREJETUP6, 3,
						  T_Path, SF_CRUSH,	  &s_firejetup7};
...
statetype s_hitmetalwall3 = {false, HITMETALWALL3,	 7, NULL,
							 0,		&s_hitmetalwall4};
statetype s_hitmetalwall2 = {false, HITMETALWALL2,	 7, NULL,
							 0,		&s_hitmetalwall3};
statetype s_hitmetalwall1 = {false, HITMETALWALL1,	 5, NULL,
							 0,		&s_hitmetalwall2};
...
statetype s_remoteinelev = {true,	  CASSATT_S1, 700,
							T_Player, 0,		  &s_remoteinelev};
...
statetype s_collectorwander8 = {false, COLLECTOR15,		   0, T_CollectorWander,
								0,	   &s_collectorwander1};
statetype s_collectorwander7 = {false, COLLECTOR13,		   1, T_CollectorWander,
								0,	   &s_collectorwander8};
statetype s_collectorwander6 = {false, COLLECTOR11,		   0, T_CollectorWander,
								0,	   &s_collectorwander7};
statetype s_collectorwander5 = {false, COLLECTOR9,		   1, T_CollectorWander,
								0,	   &s_collectorwander6};
statetype s_collectorwander4 = {false, COLLECTOR7,		   0, T_CollectorWander,
								0,	   &s_collectorwander5};
statetype s_collectorwander3 = {false, COLLECTOR5,		   1, T_CollectorWander,
								0,	   &s_collectorwander4};
statetype s_collectorwander2 = {false, COLLECTOR3,		   0, T_CollectorWander,
								0,	   &s_collectorwander3};
statetype s_collectorwander1 = {false, COLLECTOR1,		   1, T_CollectorWander,
								0,	   &s_collectorwander2};
#else

statetype s_collectorwander8 = {
	false, DOPE8, 2, T_CollectorWander, 0, &s_collectorwander1};
statetype s_collectorwander7 = {
	false, DOPE7, 2, T_CollectorWander, 0, &s_collectorwander8};
statetype s_collectorwander6 = {
	false, DOPE6, 2, T_CollectorWander, 0, &s_collectorwander7};
statetype s_collectorwander5 = {
	false, DOPE5, 2, T_CollectorWander, 0, &s_collectorwander6};
statetype s_collectorwander4 = {
	false, DOPE4, 2, T_CollectorWander, 0, &s_collectorwander5};
statetype s_collectorwander3 = {
	false, DOPE3, 2, T_CollectorWander, 0, &s_collectorwander4};
statetype s_collectorwander2 = {
	false, DOPE2, 2, T_CollectorWander, 0, &s_collectorwander3};
statetype s_collectorwander1 = {
	false, DOPE1, 2, T_CollectorWander, 0, &s_collectorwander2};
#endif

#if (SHAREWARE == 1) || (DOPEFISH == 0)
statetype s_collectorfdoor8 = {false, COLLECTOR15,		 0, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor1};
statetype s_collectorfdoor7 = {false, COLLECTOR13,		 1, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor8};
statetype s_collectorfdoor6 = {false, COLLECTOR11,		 0, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor7};
statetype s_collectorfdoor5 = {false, COLLECTOR9,		 1, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor6};
statetype s_collectorfdoor4 = {false, COLLECTOR7,		 0, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor5};
statetype s_collectorfdoor3 = {false, COLLECTOR5,		 1, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor4};
statetype s_collectorfdoor2 = {false, COLLECTOR3,		 0, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor3};
statetype s_collectorfdoor1 = {false, COLLECTOR1,		 1, T_CollectorFindDoor,
							   0,	  &s_collectorfdoor2};
#else

statetype s_collectorfdoor8 = {
	false, DOPE8, 2, T_CollectorFindDoor, 0, &s_collectorfdoor1};
statetype s_collectorfdoor7 = {
	false, DOPE7, 2, T_CollectorFindDoor, 0, &s_collectorfdoor8};
statetype s_collectorfdoor6 = {
	false, DOPE6, 2, T_CollectorFindDoor, 0, &s_collectorfdoor7};
statetype s_collectorfdoor5 = {
	false, DOPE5, 2, T_CollectorFindDoor, 0, &s_collectorfdoor6};
statetype s_collectorfdoor4 = {
	false, DOPE4, 2, T_CollectorFindDoor, 0, &s_collectorfdoor5};
statetype s_collectorfdoor3 = {
	false, DOPE3, 2, T_CollectorFindDoor, 0, &s_collectorfdoor4};
statetype s_collectorfdoor2 = {
	false, DOPE2, 2, T_CollectorFindDoor, 0, &s_collectorfdoor3};
statetype s_collectorfdoor1 = {
	false, DOPE1, 2, T_CollectorFindDoor, 0, &s_collectorfdoor2};
...
statetype s_scottwanderdoor7 = {false, SCOTHEAD7,		   4, T_CollectorWander,
								0,	   &s_scottwanderdoor1};
statetype s_scottwanderdoor6 = {false, SCOTHEAD6,		   4, T_CollectorWander,
								0,	   &s_scottwanderdoor7};
statetype s_scottwanderdoor5 = {false, SCOTHEAD5,		   4, T_CollectorWander,
								0,	   &s_scottwanderdoor6};
statetype s_scottwanderdoor4 = {false, SCOTHEAD4,		   4, T_CollectorWander,
								0,	   &s_scottwanderdoor5};
statetype s_scottwanderdoor3 = {false, SCOTHEAD3,		   4, T_CollectorWander,
								0,	   &s_scottwanderdoor4};
statetype s_scottwanderdoor2 = {false, SCOTHEAD2,		   4, T_CollectorWander,
								0,	   &s_scottwanderdoor3};
statetype s_scottwanderdoor1 = {false, SCOTHEAD1,		   4, T_CollectorWander,
...
statetype s_opshoot4 = {false, SPR_OP_SHOOT4, 10, ActorMovement,
						0,	   &s_opchase1};
statetype s_opshoot3 = {false, SPR_OP_SHOOT3, 10, ActorMovement,
						0,	   &s_opshoot4};
...
statetype s_dmonkdie1rev = {false, SPR_MONK_DIE1, 5, T_Collide,
							0,	   &s_dmonkstand};
statetype s_dmonkdie2rev = {false, SPR_MONK_DIE2,  5, T_Collide,
							0,	   &s_dmonkdie1rev};
statetype s_dmonkdie3rev = {false, SPR_MONK_DIE3,  5, T_Collide,
							0,	   &s_dmonkdie2rev};
statetype s_dmonkdie4rev = {false, SPR_MONK_DIE4,  5, T_Collide,
							0,	   &s_dmonkdie3rev};

statetype s_dmonkcrushed2 = {false, SPR_MONK_DIE3, 2, NULL, 0, &s_dmonkdead};
statetype s_dmonkcrushed1 = {false, SPR_MONK_DIE1,	 2, NULL,
							 0,		&s_dmonkcrushed2};
...
statetype s_firemonkdie1rev = {false, SPR_FIREMONK_DIE1, 5, T_Collide,
							   0,	  &s_firemonkstand};
statetype s_firemonkdie2rev = {false, SPR_FIREMONK_DIE2, 5, T_Collide,
							   0,	  &s_firemonkdie1rev};
statetype s_firemonkdie3rev = {false, SPR_FIREMONK_DIE3, 5, T_Collide,
							   0,	  &s_firemonkdie2rev};
statetype s_firemonkdie4rev = {false, SPR_FIREMONK_DIE3, 5, T_Collide,
							   0,	  &s_firemonkdie3rev};
...
statetype s_dariandead2 = {false, SPR_DARIAN_DEAD, 0, T_BossDied,
						   0,	  &s_dariandead2};
statetype s_dariandead1 = {false, SPR_DARIAN_DEAD, 140, NULL,
						   0,	  &s_dariandead2};
...
statetype s_heinrichdefend = {true, SPR_KRIST_MINERIGHT1, 35, T_Heinrich_Defend,
							  0,	&s_heinrichdefend};
...
statetype s_darkmonkbreathe1 = {false, TOMBR1, 70,
								NULL,  0,	   &s_darkmonkbreathe2};
...
statetype s_darkmonkhead = {true, TOMHEAD1,		  0, T_DarkSnakeChase,
							0,	  &s_darkmonkhead};
statetype s_darkmonksnakelink = {true,			TOMHEAD1, 0,
...
statetype s_darkmonksphere10 = {false, TSPHERE10, 4,
								NULL,  0,		  &s_darkmonkchase1};
statetype s_darkmonksphere9 = {false, TSPHERE9, 4,
							   NULL,  0,		&s_darkmonksphere10};
...
statetype s_darkmonkcharge10 = {false, TSCAREB3,		 140, T_DarkmonkCharge,
								0,	   &s_darkmonkchase1};
statetype s_darkmonkcharge9 = {false, TAWAKEN5, 3,
							   NULL,  0,		&s_darkmonkcharge10};
...
statetype s_dexplosion20 = {false, SPR_EXPLOSION20, 2, NULL,
							0,	   &s_dexplosion21};
statetype s_dexplosion19 = {false, SPR_EXPLOSION19, 2, NULL,
							0,	   &s_dexplosion20};
statetype s_dexplosion18 = {false, SPR_EXPLOSION18, 2, NULL,
							0,	   &s_dexplosion19};
statetype s_dexplosion17 = {false, SPR_EXPLOSION17, 2, NULL,
							0,	   &s_dexplosion18};
statetype s_dexplosion16 = {false, SPR_EXPLOSION16, 2, NULL,
							0,	   &s_dexplosion17};
statetype s_dexplosion15 = {false, SPR_EXPLOSION15, 2, NULL,
							0,	   &s_dexplosion16};
statetype s_dexplosion14 = {false, SPR_EXPLOSION14, 2, NULL,
							0,	   &s_dexplosion15};
statetype s_dexplosion13 = {false, SPR_EXPLOSION13, 2, NULL,
							0,	   &s_dexplosion14};
statetype s_dexplosion12 = {false, SPR_EXPLOSION12, 2, NULL,
							0,	   &s_dexplosion13};
statetype s_dexplosion11 = {false, SPR_EXPLOSION11, 2, NULL,
							0,	   &s_dexplosion12};
statetype s_dexplosion10 = {false, SPR_EXPLOSION10, 2, NULL,
							0,	   &s_dexplosion11};
...
statetype s_oshurikenhit2 = {false, SPR_OSHURHIT2,	 3, NULL,
							 0,		&s_oshurikenhit3};
statetype s_oshurikenhit1 = {false, SPR_OSHURHIT1,	 3, NULL,
							 0,		&s_oshurikenhit2};
...
statetype s_firejetdown10 = {false, FIREJETDOWN10,	 3, T_Path,
							 0,		&s_firejetdown11};
statetype s_firejetdown9 = {false, FIREJETDOWN9,	3, T_Path,
							0,	   &s_firejetdown10};
...
statetype s_columnupup4 = {false,	  CRUSHUP5, 5,
						   T_CrushUp, SF_UP,	&s_columnupup5};
statetype s_columnupup3 = {false,	  CRUSHUP6, 2,
						   T_CrushUp, SF_UP,	&s_columnupup4};
statetype s_columnupup2 = {false,	  CRUSHUP7, 5,
						   T_CrushUp, SF_UP,	&s_columnupup3};
...
statetype s_spinupblade8 = {false, SPINUBLADE_08,  2, T_Path,
							0,	   &s_spinupblade9};
statetype s_spinupblade7 = {false, SPINUBLADE_07,  2, T_Path,
							0,	   &s_spinupblade8};
statetype s_spinupblade6 = {false, SPINUBLADE_06,  2, T_Path,
							0,	   &s_spinupblade7};
statetype s_spinupblade5 = {false, SPINUBLADE_05,  2, T_Path,
							0,	   &s_spinupblade6};
statetype s_spinupblade4 = {false, SPINUBLADE_04,  2, T_Path,
							0,	   &s_spinupblade5};
statetype s_spinupblade3 = {false, SPINUBLADE_03,  2, T_Path,
							0,	   &s_spinupblade4};
statetype s_spinupblade2 = {false, SPINUBLADE_02,  2, T_Path,
							0,	   &s_spinupblade3};
...
statetype s_boulderdrop8 = {false,		   BDROP8, 1,
							T_BoulderDrop, 0,	   &s_boulderdrop9};
statetype s_boulderdrop7 = {false,		   BDROP7, 1,
							T_BoulderDrop, 0,	   &s_boulderdrop8};
statetype s_boulderdrop6 = {false,		   BDROP6, 2,
							T_BoulderDrop, 0,	   &s_boulderdrop7};
statetype s_boulderdrop5 = {false,		   BDROP5, 3,
							T_BoulderDrop, 0,	   &s_boulderdrop6};
statetype s_boulderdrop4 = {false,		   BDROP4, 4,
							T_BoulderDrop, 0,	   &s_boulderdrop5};
...
statetype s_serialdogattack = {true,	 SERIALDOG_ATTACK1, 0,
							   T_Attack, SF_DOGSTATE,		&s_serialdogattack};
